...
public class LectureController {
    ...
    public ModelAndView expression(ModelAndView mv) {
        ...
        mv.addObject("member", new MemberDTO("박재민", 20, '남', "서울시 마포구"));
    ...
    public ModelAndView conditional(ModelAndView mv) {
        ...
        memberList.add(new MemberDTO("하츄핑", 4, '여',"서울시 마포구"));
        memberList.add(new MemberDTO("시진핑", 75, '남',"베이징 사천구"));
    ...
    public ModelAndView etc(ModelAndView mv) {
        ...
        // key, value 형식으로 저장 가능하지만, key 를 작성하지 시
        ...
        memberMap.put("1", new MemberDTO("하츄핑", 4, '여',"서울시 마포구"));
        memberMap.put("2", new MemberDTO("시진핑", 75, '남',"베이징 사천구"));
